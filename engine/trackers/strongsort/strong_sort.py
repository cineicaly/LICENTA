...
from engine.trackers.strongsort.sort.nn_matching import NearestNeighborDistanceMetric
from engine.trackers.strongsort.sort.detection import Detection
from engine.trackers.strongsort.sort.tracker import Tracker

from engine.trackers.strongsort.reid_multibackend import ReIDDetectMultiBackend
...
class StrongSORT(object):
    ...
    def update(self, bboxes, confs, classes, ori_img):
