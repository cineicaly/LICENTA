...
from engine.trackers.strongsort.deep.reid_model_factory import (show_downloadeable_models, get_model_url, get_model_name,
                                                                                          load_pretrained_weights)
from engine.trackers.strongsort.deep.models import build_model
...
class ReIDDetectMultiBackend(nn.Module):
    ...
    def model_type(p='path/to/model.pt'):
        ...
        from engine.trackers.reid_export import export_formats
